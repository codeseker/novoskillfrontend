      ...
      <div className="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
        <div className="max-w-md w-full p-6">
          ...
          <h1 className="text-sm font-semibold mb-6 text-gray-500 text-center">
            Join NovoSkill to start your career.{" "}
          </h1>
          <form
          ...
          >
            ...
            <div>
              {loading === false ? (
                <button
                  type="submit"
                  className="w-full bg-indigo-500 hover:bg-indigo-600 text-white p-2 rounded-md focus:outline-none focus:bg-indigo-600 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600 transition-colors duration-300"
                >
                  Sign Up
                </button>
              ) : (
                <div
                  type="submit"
                  className="w-full flex items-center justify-center bg-indigo-500 hover:bg-indigo-600 text-white p-2 rounded-md focus:outline-none focus:bg-indigo-600 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600 transition-colors duration-300"
                >
